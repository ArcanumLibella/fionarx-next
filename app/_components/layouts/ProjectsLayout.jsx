...
export const ProjectsLayout = ({ categories, children }) => {
  return (
    <div className="ProjectsLayout flex flex-col justify-center h-svh min-h-svh md:pl-20 overflow-y-hidden">
      ...
      <div className="ProjectsLayout__filter pt-8 px-8 md:px-12 lg:px-24 xl:px-32">
        <Heading level={6} className="h6 mb-4 font-bold text-white uppercase">
          Filtrer les projets
        </Heading>
