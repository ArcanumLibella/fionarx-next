...
export const PrestationLayout = ({children, className: additionalStyle}) => {
  return (
    <div className={`PrestationLayout relative px-4 pt-40 md:pt-56 md:px-8 md:ml-20 xl:ml-0 xl:py-0 pb-16 xl:px-0 xl:top-1/4 xl:-right-1/3 3xl:-right-3/5 max-w-fit z-10 ${additionalStyle}`}>
      ...
      <div className="max-w-800 lg:max-w-5xl xl:max-w-800 2xl:max-w-[880px] 3xl:max-w-5xl">
        {children}
      </div>
    </div>
  )
