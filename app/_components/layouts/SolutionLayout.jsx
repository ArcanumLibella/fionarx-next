...
export const SolutionLayout = ({children, className: additionalStyle}) => {
  return (
    <div className={`SolutionLayout relative px-4 pt-40 md:pt-56 md:px-8 md:ml-20 xl:ml-0 xl:py-0 pb-16 xl:px-0 xl:top-1/4 xl:-right-1/3 3xl:-right-2/5 max-w-fit z-10 ${additionalStyle}`}>
