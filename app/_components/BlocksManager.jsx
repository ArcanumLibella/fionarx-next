            ...
            return (
              <BlocksRenderer
                ...
                blocks={{
                  ...
                  link: ({ children, url }) => <a key={`link-${block.id}`} href={url} target="_blank" rel="noreferrer" title="Ouvrir le lien" className="Link font-bold text-tomato hover:!underline">{children}</a>,
