...
export const DescriptionCard = ({ description }) => {
  ...
  return (
    <div className="DescriptionCard flex flex-col justify-between items-center md:h-full md:min-h-[188px] md:max-h-[220px] xl:min-h-[220px] xl:max-h-[272px] 2xl:min-h-[180px] 2xl:max-h-[220px] 3xl:min-h-[180px] 3xl:max-h-[192px] md:mx-4 xl:mx-3 mb-4 p-2">
      <BlocksRenderer 
        content={description}
        blocks={{
          paragraph: ({ children }) => (
