...
if (!cardsPrestation) return;
  ...
  return (
    <div className="CardsPrestation relative flex flex-col">
      ...
      <div className="CardsPrestation__wrapper flex lg:flex-wrap mb-8 md:mb-12 !-mx-4 md:!-mx-8 xl:!mx-0 px-4 md:px-8 xl:px-0 overflow-x-auto lg:overflow-hidden max-w-800 lg:max-w-5xl xl:max-w-800 2xl:max-w-5xl scrollbar-hidden">
