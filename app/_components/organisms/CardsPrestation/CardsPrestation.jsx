  ...
  return (
    <div className="relative">
      <ArrowRightIcon 
        ...
        height={40}
      />
      <div className="CardsPrestation flex lg:grid lg:grid-cols-3 gap-8 px-4 mb-12 !-mx-4 overflow-x-auto lg:overflow-hidden max-w-800 lg:max-w-5xl xl:max-w-800 2xl:max-w-5xl md:px-8 md:!-mx-8 xl:!mx-0 xl:px-0 xl:gap-10 scrollbar-hidden">
