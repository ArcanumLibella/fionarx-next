...
export const Hero = async () => {
  ...
  return (
    <div className="Hero flex flex-col items-center justify-center h-screen h-svh overflow-hidden text-center px-4 md:pl-16 md:pr-8 lg:px-16 lg:py-16 md:items-end md:text-right bg-midnight">
