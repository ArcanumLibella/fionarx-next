...
export const ImagesSlider = ({ images }) => {
  ...
  return (
    <div className="ImagesSlider relative">
      <div className="ImagesSlider__images flex max-h-[640px] px-4 mb-12 !-mx-4 overflow-x-auto lg:max-w-5xl xl:max-w-800 2xl:max-w-5xl md:px-8 md:!-mx-8 xl:!mx-0 xl:px-0 scrollbar-hidden">
